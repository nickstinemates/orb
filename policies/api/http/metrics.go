...
func (m metricsMiddleware) DatasetsStatistics(ctx context.Context, token string) (policies.DatasetStatistics, error) {
	return m.svc.DatasetsStatistics(ctx, token)
}
